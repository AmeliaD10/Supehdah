    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <div class="flex-1 p-6">
            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <h2 class="text-2xl font-semibold mb-4">List of Clinics</h2>
                            ...
                            @forelse ($clinics as $index => $clinic)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('admin.clinics.view', $clinic->id) }}" class="text-blue-600 hover:underline">View</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">No clinics found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
